...
import org.sagebionetworks.bridge.android.data.DataArchive;
...
public class UploadManager {
    ...
    public Completable upload(String filename, DataArchive dataArchive) throws
            IOException, CMSException {

        Single<UploadFile> uploadFileSingle = Single
                .fromCallable(() -> persist(filename, dataArchive));
    ...
    public UploadFile persist(String filename, DataArchive dataArchive) throws IOException,
        ...
        dataArchive.writeTo(encryptedOutputStream);
