...
public abstract class BridgeDataProvider extends DataProvider {
  ...
  BridgeDataProvider(String baseUrl, String studyId, String userAgent, BridgeService service,
  ...
  private void uploadConsent(Context context, String subpopulationGuid,
  ...
  public void uploadTaskResult(Context context, TaskResult taskResult) {
    ...
    uploadBridgeData(context, new Info(context, getGuid(taskResult.getIdentifier()),
  ...
  public void uploadBridgeData(Context context, Info info, List<BridgeDataInput> dataFiles) {
    try {
      ...
      UploadRequest request =
          archive.finishAndEncrypt(context, getPublicKeyResId(), getFilesDir(context));
